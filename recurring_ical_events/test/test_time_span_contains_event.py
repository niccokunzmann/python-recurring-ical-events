...
# check that datetime and date can be used and mixed
    (datetime(2019, 1, 1, 1), datetime(2019, 1, 4, 1), date(2019, 1, 2), date(2019, 1, 3), True, "date is in datetime span"),
...
#  in the range.
    (date(2019, 1, 4), date(2019, 1, 5), date(2019, 1, 3), date(2019, 1, 4), False, "We should not include an event which ends at a requested start date."),
    (datetime(2019, 1, 4), datetime(2019, 1, 5), date(2019, 1, 3), date(2019, 1, 4), False, "We should not include an event which ends at a requested start date."),

    (datetime(2019, 1, 4), datetime(2019, 1, 5), datetime(2019, 1, 4, 3), datetime(2019, 1, 5), True, "We should include an event which ends at an end date but is included"),
# Events with 0 duration should be tested
    ...
    (date(2019, 1, 4), date(2019, 1, 4), date(2019, 1, 4), date(2019, 1, 4), True, "We should include an event which is of the same size as the span"),
    (date(2019, 1, 3), date(2019, 1, 4), date(2019, 1, 4), date(2019, 1, 4), False, "We should NOT include an event which ends at an end date but is included"),

    (0, 0, 1, 1, False, "zero size event after"),
    (2, 2, 1, 1, False, "zero size event before"),

# Test the exclusivity of the end of the span
    (1, 3, 3, 4, False, "When the event starts at the end of the span, it should not be included."),
