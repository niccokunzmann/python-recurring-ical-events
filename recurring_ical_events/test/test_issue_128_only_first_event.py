...
"""
import recurring_ical_events.repeated_component
import pytest
...
def test_matching_negative_count(string, matches):
    ...
    actually_matches = recurring_ical_events.repeated_component.NEGATIVE_RRULE_COUNT_REGEX.match(string) is not None
